...
interface IFooterTermsProps {
  isOpen: any;
  closeModal: any;
}
const FooterTermsCondition: React.FC<IFooterTermsProps> = ({
  isOpen,
  closeModal,
}) => {
  if (!isOpen) {
      ...
      <ModalContent>
        ...
        <ModalBody style={{ overflowY: "auto", maxHeight: "60vh" }}>
          <Text>
            ...
            By accessing or using the Fooderra website, you agree to comply with
            ...
            Fooderra a non-exclusive, royalty-free, worldwide, perpetual license
            to use, publish, and distribute the content. <br /> b. You are
            solely responsible for the content you submit and ensure that it
            ...
            images, is the property of Fooderra and is protected by intellectual
            property laws.
            <br />
            ...
            <br /> c. Attempting to gain unauthorized access to the Site or its
            related systems.{" "}
            <Text fontWeight={600}>6. Disclaimer of Warranty</Text> a. Fooderra
            makes no warranties or representations about the accuracy or
            completeness of the content on the Site.
            ...
            Fooderra reserves the right to modify these terms and conditions at
            any time. Your continued use of the Site after such modifications
            will constitute your acknowledgment of the modified terms.
            <Text fontWeight={600}> 9. Governing Law </Text>
            These terms and conditions are governed by and construed in
            accordance with the laws.
            <Text fontWeight={600}> 10. Contact Information </Text> If you have
            any questions or concerns about these terms and conditions, you can
            contact us at{" "}
            <span
