              ...
              />
                <HStack gap='16px' pt='8px' fontSize='16px' fontWeight='500px' color='gray.400'>
                    <Link href={"/blog"} passHref>
                        <Button variant="link" _hover={{ color: '#233345' }}>Blog</Button>
                    </Link>
                    <Link href={"/recipes"} passHref>
                        <Button variant="link" _hover={{ color: '#233345' }}>Recipes</Button>
                    </Link>
                    <Link href={"/help"} passHref>
                        <Button variant="link" _hover={{ color: '#233345' }}>Help</Button>
                    </Link>
                </HStack>
            </HStack>
            <HStack gap='16px'>
                <HStack bg='white' borderRadius="500px" fontSize='16px' fontWeight='500px'>
                    <Link href={"/login"}>
                        <Button variant="link" _hover={{ color: '#233345' }} p='8px 16px'>Already have an account? Log in</Button>
                    </Link>
